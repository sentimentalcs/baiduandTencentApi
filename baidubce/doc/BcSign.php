...
// |          Your Name < Mr Gao >                                        |
// +----------------------------------------------------------------------+
namespace app\api\modules\content\models\bce_doc_sdk_php;
class BcSign {
    // 根据RFC 3986，除了：
    //   1.大小写英文字符
    //   2.阿拉伯数字
    ...
    public  function getSigner($host,$httpMethod, $path, $parms, $timestamp)
    {
        self::__init();
        //	date_default_timezone_set('UTC');

        $AK = $this->config['ak'];    //AK
        $SK = $this->config['sk'];    //SK
