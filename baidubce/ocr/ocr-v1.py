...
if __name__ == "__main__":
    credentials = BceCredentials("your ak","your sk") #替换成自己的AK SK
    http_method = "POST"
    host = 'ocr.bj.baidubce.com'
    path = '/v1/recognize/text'
    timestamp = int(time.time()) 
    body = '{"bosPath":"your_bucketname/your_objectKey","language":"CHN_ENG"}'  #替换成自己的BOS BucketName和Objectkey
    ...
    try:
      ...
      httpClient.request(method=http_method,url=path,body=body,headers=headers)
